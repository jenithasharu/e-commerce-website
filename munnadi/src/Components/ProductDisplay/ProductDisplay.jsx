    ...
    <div className="productdisplay">
        ...
        <div className="productdisplay-right">
            ...
            <div className="productdisplay-right-description">
                Classic men’s short-sleeve shirt crafted from breathable cotton, featuring a tailored fit, button-down front, and versatile design suitable for both casual and semi-formal wear.
            </div>
